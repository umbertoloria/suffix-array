...
use crate::files::paths::{
    ...
    get_path_for_project_outcome_file_json, get_path_for_project_prefix_tree_add_file,
...
use crate::suffix_array::prefix_tree::logging::{log_prefix_tree_add, log_tree, TreeLogMode};
...
pub fn compute_innovative_suffix_array(
    ...
    let mut tree = create_tree(s_bytes, &icfl_indexes, chunk_size, &mut monitor);
    ...
    if log_execution {
        ...
        // Prefix Tree Add logs
        log_prefix_tree_add(
            &execution_info.execution_outcome.prefix_tree_add,
            get_path_for_project_prefix_tree_add_file(fasta_file_name, chunk_size_or_zero),
        );
